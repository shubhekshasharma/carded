  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-semibold tracking-wide ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: "bg-gradient-primary text-primary-foreground shadow-glow hover:shadow-hover transform hover:scale-105 font-bold",
        card: "bg-gradient-accent text-accent-foreground shadow-card hover:shadow-hover transform hover:scale-105",
        legendary: "bg-gradient-legendary text-primary-foreground shadow-glow animate-pulse-glow font-bold",
        quiz: "bg-gradient-secondary text-secondary-foreground hover:shadow-hover transform hover:scale-105",
      },
      size: {
